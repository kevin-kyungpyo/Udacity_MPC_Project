        ...
        if (event == "telemetry") {
          ...
          */
          ...
          for (int i = 0; i < NumOfPt; i++)
          {
            ...
            eigenPtsx[i] = (dx * cosPsi - dy * sinPsi);
            eigenPtsy[i] = (dy * cosPsi + dx * sinPsi);
          }
          ...
          std::cout << "input(throttle, steering): " << throttle_value << ","
          << steer_value << std::endl;
          mpc.SetPreInput(steer_value, throttle_value);
          ...
          for (int i = 0; i < NumOfPt; i++)
          {
            next_x_vals.push_back(eigenPtsx[i]);
            next_y_vals.push_back(eigenPtsy[i]);
          }
